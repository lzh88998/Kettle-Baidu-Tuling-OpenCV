...
@Step(
		  id = "BaiduTTSStep",
		  name = "BaiduTTS.Name",
		  description = "BaiduTTS.TooltipDesc",
		  image = "org/pentaho/di/sdk/steps/baidutts/resources/baidutts.svg",
		  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Experimental",
		  i18nPackageName = "org.pentaho.di.sdk.steps.baidutts"
		  )
public class BaiduTTSStepMeta  extends BaseStepMeta implements StepMetaInterface {
...
/*	  private String proxyHost;
	  ...
	  public BaiduTTSStepMeta() {
	    super();
	  }

	  public StepDialogInterface getDialog( Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
	    return new BaiduTTSStepDialog( shell, meta, transMeta, name );
	  }

	  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
	      Trans disp ) {
	    return new BaiduTTSStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
	  }

	  public StepDataInterface getStepData() {
	    return new BaiduTTSStepData();
	  }
...
/*	  public void setProxyHost(String host) {
	  ...
	  public Object clone() {
		  BaiduTTSStepMeta retval = (BaiduTTSStepMeta)super.clone();
...
/*	    	setProxyHost( XMLHandler.getNodeValue( XMLHandler.getSubNode( stepnode, "proxyhost" ) ) );
	      ...
	      throw new KettleXMLException( "BaiduTTS plugin unable to read step info from XML node", e );
	    }
	  }
	  ...
	  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
	    ...
	    if(token == null || token == "") {
		    cr = new CheckResult( CheckResult.TYPE_RESULT_ERROR,
		    		BaseMessages.getString( PKG, "BaiduTTS.CheckResult.Key.ERROR" ), stepMeta );
		    		remarks.add( cr );
		    return;
	    }
	    ...
	    if(inputField == null || inputField == "") {
		    cr = new CheckResult( CheckResult.TYPE_RESULT_ERROR,
		    		BaseMessages.getString( PKG, "BaiduTTS.CheckResult.ReceivingRows.ERROR" ), stepMeta );
		    		remarks.add( cr );
		    return;
	    }

	cr = new CheckResult( CheckResult.TYPE_RESULT_OK,
			        BaseMessages.getString( PKG, "BaiduTTS.CheckResult.ReceivingRows.OK" ), stepMeta );
		remarks.add( cr );
	  }
	  
	  public String getBinaryStreamField() {
		  return "Speech Stream";
	  }
}
